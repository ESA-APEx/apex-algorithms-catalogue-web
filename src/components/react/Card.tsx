          ...
          <div className="card-labels">
            ...
            <div className="flex flex-nowrap gap-2 overflow-hidden">
              {displayedLabels.map((label) => (
                <span
                  key={label}
                  className="text-sm text-nowrap px-2 py-1 text-brand-teal-80 bg-white"
              ...
              {hiddenLabels?.length ? (
                <span
                  className="text-sm text-nowrap px-1 py-1 text-brand-teal-80"
                  data-testid="service-hidden-label"
                >
                  +{hiddenLabels.length}
                </span>
              ) : null}
