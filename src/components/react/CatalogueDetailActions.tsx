...
export const CatalogueDetailActions = ({
  data,
  toc,
  ...
  const exampleLinks = data.links.filter(
    (item) => item.rel === "example-output",
  );
          ...
          {exampleLinks.length > 0 && (
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button
                  variant="secondary"
                  className="text-md font-normal flex-1 max-w-44"
                >
                  <Files />
                    ...
                    link.href.includes(".json") ? (
                      <>
                        ...
                        <a
                          href={
                            new URL(
                              link.href.replace("https://", "/external/"),
                              BASE_STAC_BROWSER_URL,
                            ).href
                          }
                          target="__blank"
